...
const IN_APP: Record<string, string> = {
  ...
  music: '/music',
  // Знакомства: колода свайпов, лайки и связи — своими экранами. Колоду
  // листают пальцем десятками анкет подряд, и жест должен жить на потоке
  // интерфейса телефона, а не в браузерной вкладке; пуш «Новая заявка» тоже
  // должен приводить в приложение. Вход — в раздел: он сам решит, вести ли
  // в подбор или сначала попросить место и анкету.
  union: '/union',
};
