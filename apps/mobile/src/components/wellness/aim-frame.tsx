 ...
 *
 * Рамка — живая подсказка во время наведения, а не индикатор итога: она
 * показывает, куда класть штрихкод, и меняется по ходу чтения. Красная —
 * кода не видно, жёлтая — декодировался, но не сошёлся с контрольной цифрой,
 * зелёная — прочитан. Цвет здесь помощник, а не носитель смысла: то же самое
