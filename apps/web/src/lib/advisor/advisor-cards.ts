...
/**
 * Склонение слов при числительном. Нужно ровно для «5 человек ждут» и
 * «3 дня» — тащить ради этого библиотеку интернационализации незачем,
 * а «5 человек ждет» в тексте, который человек читает про себя, режет глаз.
 */
