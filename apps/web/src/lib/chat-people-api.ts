// API-клиент раздела «Люди» сервиса «Общение».
...
export const getContactsProfileState = (signal?: AbortSignal) =>
  requestJson<ContactsProfileState>("/chat/people/profile", {
    method: "GET",
    signal,
  });
...
export const getContactsTags = (signal?: AbortSignal) =>
  requestJson<ContactsTagsResponse>("/chat/people/tags", { method: "GET", signal });

export const updateContactsProfile = (body: ContactsUpdateProfileRequest) =>
  requestJson<ContactsProfileDto>("/chat/people/profile", {
    method: "PUT",
...
export const searchContacts = (
  ...
  return requestJson<ContactsSearchResponse>(
    query ? `/chat/people/search?${query}` : "/chat/people/search",
    { method: "GET", signal },
  );
};
...
export const getContactsMapPoints = (
  ...
  return requestJson<ContactsMapResponse>(
    query ? `/chat/people/map?${query}` : "/chat/people/map",
    { method: "GET", signal },
  );
};
...
export const getContactsCard = (userId: string, signal?: AbortSignal) =>
  requestJson<ContactsCardDto>(
    `/chat/people/users/${encodeURIComponent(userId)}`,
    { method: "GET", signal },
  );
...
export const getContactsRequests = (signal?: AbortSignal) =>
  requestJson<ContactsRequestsState>("/chat/people/requests", {
    method: "GET",
    signal,
  });
...
export const respondToContactsRequest = (
  ...
  requestJson<ContactsRequestsState>(
    `/chat/people/requests/${encodeURIComponent(requestId)}/respond`,
    {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
export const revokeContactsDisclosure = (disclosureId: string) =>
  requestJson<ContactsDisclosuresState>(
    `/chat/people/disclosures/${encodeURIComponent(disclosureId)}`,
    { method: "DELETE" },
  );
