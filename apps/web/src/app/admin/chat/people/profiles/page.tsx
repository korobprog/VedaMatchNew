...
import { PeopleProfileActions } from "@/components/chat/people/admin/profile-actions";
import { formatDate } from "@/lib/admin-labels";
import { getContactsAdminProfiles } from "@/lib/api";

export const metadata = {
  title: "Общение: люди — карточки",
...
export default async function AdminContactsProfilesPage({
  ...
  return (
    <>
      <PeopleAdminTabs active="profiles" />
...
function PageLink({
  ...
  return (
    <Link
      href={`/admin/chat/people/profiles?${params.toString()}`}
