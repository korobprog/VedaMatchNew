    ...
    <main className="mx-auto flex max-w-7xl flex-col gap-6 px-4 py-8 md:px-6 md:py-10 lg:flex-row">
      ...
      <header className="flex flex-col gap-1.5">
        ...
        <p className="text-sm text-text-2">
          Свои записи и свободно распространяемые попадают в каталог сразу.
          Записи с чужих программ проходят проверку редакцией — до неё их
          слышите только вы.
        </p>
      </header>
      ...
      <p className="mb-4 max-w-2xl text-sm text-text-2">
        Запись в каталоге может скрыться по жалобам слушателей — три обычные
        или одна о нарушении прав. Тогда её смотрит редакция, и причина
        решения появится здесь же, на карточке. Если за неделю решения не
        будет, запись вернётся вам: файл останется, место в квоте — тоже.
      </p>
      {data ? (
