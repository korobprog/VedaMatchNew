...
import { PeopleRequestsView } from "./people-requests-view";
...
describe("PeopleRequestsView", () => {
  ...
  it("keeps the hiding checkbox off and declines without it by default", async () => {
    ...
    expect(String(url)).toBe(
      "http://localhost:4000/chat/people/requests/r1/respond",
    );
