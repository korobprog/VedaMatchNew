...
/**
 * Сколько держать слайд. У записки — по длине текста: короткую успевают
 * прочесть за три секунды, длинную нет, и одинаковый срок для обеих
 * означает, что половину моментов дочитывают на паузе.
 */
