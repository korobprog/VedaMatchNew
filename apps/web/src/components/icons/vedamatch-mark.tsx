  ...
  return (
    ...
    >
      {/* Глобус. Поднят к верхней кромке: в оригинале он парит над «M»,
          и зазор между ними — часть узнаваемости знака. */}
      <circle cx="32" cy="13" r="10.5" fill={`url(#${gid("ocean")})`} />
      {/* Материки: не карта, а намёк на неё — на 20 px точность всё равно
          не различима, а лишние детали превращаются в грязь. */}
      <path
        d="M25.5 7.5c2.4-.6 4 .8 5.6.3 1.5-.5 2.4-2 4-1.6 1.3.3 1.6 1.7.8 2.6-1 1.1-3 .9-3.6 2.2-.5 1.2.8 2.2.3 3.4-.6 1.4-3 1.2-3.8 2.5-.7 1.2.3 2.7-.5 3.7-.8 1-2.5.6-3.4-.3-1.6-1.6-2.2-4.2-1.8-6.4.3-2 1-4.3 2.4-6.4Z"
        fill={`url(#${gid("land")})`}
      />
      <path
        d="M38.5 12.6c1.3-.3 2.6.4 3.3 1.5.7 1.1.6 2.7-.3 3.6-.8.8-2.2.9-3 .2-1-.9-1.2-2.6-.6-3.8.2-.5.4-1 .6-1.5Z"
        fill={`url(#${gid("land")})`}
      />
      {/* Меридиан: одна дуга уже читается как сфера, целая сетка на малом
          размере сливается в шум. */}
      <path
        d="M32 2.5c3.2 3 5 6.6 5 10.5s-1.8 7.5-5 10.5"
        stroke="#BFDBFE"
        strokeOpacity="0.55"
        strokeWidth="1.1"
        fill="none"
