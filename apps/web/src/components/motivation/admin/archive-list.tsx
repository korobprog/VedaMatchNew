...
/**
 * Отложенное: отклонённое и снятое с показа. Список компактный и свёрнут по
 * умолчанию — он нужен, чтобы такую мотивацию можно было найти и удалить, а
 * не чтобы её перечитывать.
 *
 * Опубликованного здесь нет: за ним приходят с другим вопросом, и у него
 * своя вкладка. Свёрнутый список, где вышедшее лежало вперемешку с
 * отклонённым, прятал и то, и другое.
 */
