 ...
 * карточке и на странице материала: кадр целиком, в своих пропорциях и без
 * полей вокруг (VED-138). Заказчик дважды просил «чтобы помещалась
 * полностью», и увидеть это надо до публикации, а не после.
 *
