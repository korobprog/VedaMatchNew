...
const text = {
  ru: {
    ...
    "form.sourceHint": "Произведение, а если нужно — издание или перевод.",
    "form.sourcePlaceholder": "Бхагавад-гита",
    ...
    "form.draftRestored": "Вернули несохранённые правки.",
    "form.draftDiscard": "Начать заново",
    ...
    "error.translation_required": "Заполните перевод.",
  ...
  en: {
    ...
    "form.source": "Source",
    "form.sourceHint": "The work, and the edition or translation if needed.",
    "form.sourcePlaceholder": "Bhagavad-gita",
    ...
    "form.draftRestored": "Your unsaved changes are back.",
    "form.draftDiscard": "Start over",
    "form.saving": "Saving…",
    "form.cancel": "Cancel",
    "form.saved": "Saved",
    "form.imagesFailed":
    ...
    "error.translation_required": "Fill in the translation.",
