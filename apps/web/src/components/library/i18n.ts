...
const ui = {
  ru: {
    ...
    "entry.open": "Открыть",
    "entry.contents": "Содержание",
    "contents.loading": "Загружаю содержание…",
    "contents.failed": "Не удалось загрузить содержание",
    "contents.empty": "Текстовых материалов здесь пока нет",
    "entry.openLink": "Открыть по ссылке",
    ...
    "blank.clean": "Убрать пустые строки",
    "blank.keep": "оставлять пустых строк",
    "blank.keep0": "ни одной",
    "blank.keep1": "одну",
    "blank.undo": "Вернуть как было",
    "blank.undone": "Текст возвращён как был.",
    "blank.nothing": "Пустых строк между абзацами не нашлось.",
    ...
    "entry.embedFallback": "Не показывается? Открыть видео по ссылке",
    "cover.enlarge": "Увеличить картинку",
    "cover.viewer": "Картинка материала",
    "cover.download": "Скачать",
    "cover.close": "Закрыть",
    "cover.zoomHint": "Нажмите на картинку, чтобы приблизить",
    "cover.unzoomHint": "Нажмите ещё раз, чтобы увидеть целиком",
    ...
    "entry.toBlogConfirm": "Опубликовать материал постом в Блог-ленте?",
    "entry.toBlogYes": "Опубликовать",
    "entry.toBlogCancel": "Отмена",
    "entry.toBlogFailed": "Не удалось отправить в Блог-ленту, попробуйте позже",
    "entry.toBlogLimit": "На сегодня постов в Блог-ленте достаточно — попробуйте завтра",
    "entry.inBlog": "В Блог-ленте",
    "entry.openBlogPost": "Открыть пост",
    "entry.speak": "Озвучить",
    "entry.speakStop": "Остановить озвучку",
  ...
  en: {
    ...
    "contents.loading": "Loading the contents…",
    "contents.failed": "Could not load the contents",
    "contents.empty": "No text materials here yet",
    "entry.openLink": "Open the link",
    ...
    "blank.clean": "Remove blank lines",
    "blank.keep": "blank lines to keep",
    "blank.keep0": "none",
    "blank.keep1": "one",
    "blank.undo": "Put it back as it was",
    "blank.undone": "The text is back as it was.",
    "blank.nothing": "No blank lines between paragraphs.",
    ...
    "entry.embedFallback": "Not showing? Open it on the source site",
    "cover.enlarge": "Enlarge the picture",
    "cover.viewer": "Material picture",
    "cover.download": "Download",
    "cover.close": "Close",
    "cover.zoomHint": "Tap the picture to zoom in",
    "cover.unzoomHint": "Tap again to see it whole",
    ...
    "entry.toBlogConfirm": "Publish this material as a Blog feed post?",
    "entry.toBlogYes": "Publish",
    "entry.toBlogCancel": "Cancel",
    "entry.toBlogFailed": "Could not send to the Blog feed, please try again later",
    "entry.toBlogLimit": "Enough Blog feed posts for today — try again tomorrow",
    "entry.inBlog": "In the Blog feed",
    "entry.openBlogPost": "Open the post",
    "entry.speak": "Read aloud",
    "entry.speakStop": "Stop reading",
