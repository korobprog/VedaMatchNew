 ...
 *
 * В уведомлениях (VED-251) поле стоит на разделах списка: край карточки — в
 * 40px от края экрана, стрелки кончаются на 36px. Кнопка отметки прочтения
 * заезжает в поле карточки (`-mr-2`) и начинается в 49px — вплотную к
 * колонке прокрутки (48px), но не под ней. Замерено на 320, 360 и 412px.
 */
