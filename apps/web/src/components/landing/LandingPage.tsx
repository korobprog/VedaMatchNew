...
export function LandingPage({
  ...
  return (
    <div className="hex-cursor relative min-h-dvh bg-bg-0">
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            >
              ...
              >
                ...
                {/* Единственное место, где число сервисов осталось цифрой:
                    гостю каталог не отдаётся, считать нечего. Источник истины —
      ...
      {/* Services Section — весь каталог платформы; число сервисов приходит из
          каталога, а не зашито здесь: оно менялось трижды за месяц */}
      <Services />
