    ...
    <div className="space-y-5">
      <SelectField
        ...
        options={[
          ...
          // «Хочу углублять» отвечало не на тот вопрос: спрашивают, как
          // человек описывает свой интерес сейчас, а не чего он хочет.
          // Остальные три варианта тоже описывают состояние, а не желание.
          ["deepening", "Углубляю регулярную практику"],
