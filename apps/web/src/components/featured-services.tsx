 ...
 *
 * У будущего сервиса `href` не задаётся: вместо ссылки показывается плашка
 * «Скоро», потому что приглушённая ссылка ведёт на пустую страницу и человек
 * возвращается ни с чем. Так здесь жила Работа, пока у неё не появилась
 * витрина раздела.
 */
