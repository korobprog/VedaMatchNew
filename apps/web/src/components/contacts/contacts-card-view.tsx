...
import { ContactsApiError, getContactsCard } from "@/lib/contacts-api";
import { ContactsRequestButton } from "./contacts-request-button";
import {
...
export function ContactsCardView({ userId }: { userId: string }) {
