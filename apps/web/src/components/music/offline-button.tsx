 ...
 *
 * Эта копия живёт внутри портала и уходит вместе с записью, если её снимут.
 * Файл наружу отдаёт отдельная кнопка «Скачать файл» (VED-107) — владелец
 * решил дать её всем участникам, хотя план сервиса поначалу её не
 * предусматривал.
 */
