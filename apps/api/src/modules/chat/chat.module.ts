...
import { ChatConferenceRetentionService } from './conference/chat-conference-retention.service';
...
import { ChatOfficialPostWorkerService } from './chat-official-post-worker.service';
...
@Module({
  ...
  providers: [
    ...
    ChatConferenceRetentionService,
    ChatMessagesService,
    ChatReportsService,
    ChatEventsService,
    ChatPresenceService,
    ...
    ChatOfficialNewsListener,
    ChatOfficialPostWorkerService,
