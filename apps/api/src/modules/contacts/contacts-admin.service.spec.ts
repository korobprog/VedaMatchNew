...
function createService(options: { tag?: Record<string, unknown> | null } = {}) {
  ...
  const service = new ContactsAdminService(
...
describe('ContactsAdminService.deleteTag', () => {
...
describe('ContactsAdminService.hideProfile', () => {
...
describe('ContactsAdminService.restoreProfile', () => {
