...
export interface WorkAvatarRow {
 ...
 * импортировать `UsersService`, а участникам среды, исполнителям и авторам комментариев в «Работе» (VED-492) ссылка на фото
 ...
 */
@Injectable()
export class WorkAvatarService {
  ...
  async resolveAvatarUrl(user: WorkAvatarRow): Promise<string | null> {
   ...
   */
  async signAvatars(
    users: Iterable<WorkAvatarRow | null | undefined>,
  ): Promise<void> {
