...
export interface RewardsAvatarRow {
 ...
 * импортировать `UsersService`, а приглашённым в списке «Баллов» (VED-492) ссылка на фото
 ...
 */
@Injectable()
export class RewardsAvatarService {
  ...
  async resolveAvatarUrl(user: RewardsAvatarRow): Promise<string | null> {
   ...
   */
  async signAvatars(
    users: Iterable<RewardsAvatarRow | null | undefined>,
  ): Promise<void> {
