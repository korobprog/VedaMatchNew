...
export interface NoticesAvatarRow {
 ...
 * импортировать `UsersService`, а автору объявления и откликнувшимся в «Объявлениях» (VED-492) ссылка на фото
 ...
 */
@Injectable()
export class NoticesAvatarService {
  ...
  async resolveAvatarUrl(user: NoticesAvatarRow): Promise<string | null> {
   ...
   */
  async signAvatars(
    users: Iterable<NoticesAvatarRow | null | undefined>,
  ): Promise<void> {
