...
export interface CommunityAvatarRow {
 ...
 * импортировать `UsersService`, а участникам общины в её списке (VED-492) ссылка на фото
...
export class CommunityAvatarService {
  ...
  async resolveAvatarUrl(user: CommunityAvatarRow): Promise<string | null> {
   ...
   */
  async signAvatars(
    users: Iterable<CommunityAvatarRow | null | undefined>,
  ): Promise<void> {
