...
export interface VacanciesAvatarRow {
 ...
 * импортировать `UsersService`, а автору вакансии и откликнувшимся в «Вакансиях» (VED-492) ссылка на фото
 ...
 */
@Injectable()
export class VacanciesAvatarService {
  ...
  async resolveAvatarUrl(user: VacanciesAvatarRow): Promise<string | null> {
   ...
   */
  async signAvatars(
    users: Iterable<VacanciesAvatarRow | null | undefined>,
  ): Promise<void> {
