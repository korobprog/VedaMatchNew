...
export interface MarketAvatarRow {
 ...
 * импортировать `UsersService`, а собеседникам в чате Рынка и авторам отзывов (VED-492) ссылка на фото
 ...
 */
@Injectable()
export class MarketAvatarService {
  ...
  async resolveAvatarUrl(user: MarketAvatarRow): Promise<string | null> {
   ...
   */
  async signAvatars(
    users: Iterable<MarketAvatarRow | null | undefined>,
  ): Promise<void> {
