...
export interface MusicAvatarRow {
 ...
 * импортировать `UsersService`, а владельцам плейлистов в «Музыке» (у друзей) (VED-492) ссылка на фото
 ...
 */
@Injectable()
export class MusicAvatarService {
  ...
  async resolveAvatarUrl(user: MusicAvatarRow): Promise<string | null> {
   ...
   */
  async signAvatars(
    users: Iterable<MusicAvatarRow | null | undefined>,
  ): Promise<void> {
