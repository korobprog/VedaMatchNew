 ...
 */
/**
 * «Арджун» из списка убран намеренно. Знак ударения на этом слове сбивает
 * синтез на нерусское чтение, и окончание звучит как «АрджунЭ» — заметнее и
 * хуже, чем ударение не на том слоге. Без пометки модель читает «Арджуне»
 * правильно.
 */
 ...
 */
const ENDINGS = '(?:а|ы|е|у|ой|ою|ом|ах|ами|и|я|ю|ей|ем|ов|у́|)(?![а-яё])';
...
function matchCase(source: string, replacement: string): string {
  ...
  if (
    ...
    first !== first.toLocaleLowerCase('ru-RU')
  )
