...
const services = [
  ...
  },
  {
    ...
    url: '/music',
    // Включён: каталог, плеер, плейлисты, офлайн и лента друзей на месте.
    // Условие включения из плана — наполненный каталог: пустой сервис на
    // витрине уже показывал, чем это кончается (Рынок с одним лотом).
    status: 'active',
    category: 'lifestyle',
    public: true,
    seekerVisible: true,
