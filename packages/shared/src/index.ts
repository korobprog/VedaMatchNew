...
export const ADMIN_SERVICE_SLUGS = [
  // Вход — такой же сервис портала, как остальные: им управляют из админки, и
  // его можно назначить менеджеру. Отдельных логинов под сервисы нет, права
  // выдаются участнику портала.
  'auth',
  'union',
  'chat',
  'market',
